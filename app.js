...
function showPage(name) {
  if (name === 'home') { loadStats(); loadVivante(); loadHomeProjects(); loadAdminPublicInfo(); }
  if (name === 'contact') {
...
if (backBtn) backBtn.style.display = (name === 'home') ? 'none' : 'flex';
 ...
 if (name === 'home') { loadStats(); loadVivante(); loadAdminPublicInfo(); }
    if (name === 'chambres') {} 
if (name === 'teachers') { loadTeachersHome(); }
if (name === 'teacher-profile') { loadTeacherProfile(); }
    if (name === 'settings') { loadProfileData(); }
}
